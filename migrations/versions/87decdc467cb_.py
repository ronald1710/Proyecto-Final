...
Revision ID: 87decdc467cb
Revises: 7b341695f43f
Create Date: 2022-11-03 00:20:54.536668
...
def upgrade():
    ...
    sa.Column('consejos', sa.String(length=250), nullable=False),
    sa.Column('origen', sa.String(length=250), nullable=False),
    sa.Column('salud', sa.String(length=250), nullable=False),
    sa.Column('ejercicio', sa.String(length=250), nullable=False),
    sa.Column('aseo', sa.String(length=250), nullable=False),
    sa.Column('raza_nino', sa.String(length=250), nullable=False),
    sa.Column('dog_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dog_id'], ['dogs.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('aseo'),
    sa.UniqueConstraint('consejos'),
    sa.UniqueConstraint('descripcion'),
    sa.UniqueConstraint('ejercicio'),
    sa.UniqueConstraint('origen'),
    sa.UniqueConstraint('raza_nino'),
    sa.UniqueConstraint('salud')
    )
